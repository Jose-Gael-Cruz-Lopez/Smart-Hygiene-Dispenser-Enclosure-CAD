...
- Keeping external clutter minimal: only **two cables exit the enclosure that connect to power outlet** and cables that go into the box, one for raspi and one for the modem. All other cables stay neatly inside, connecting the Pi directly to the screen.  
